...
async function decrementWinnerTrophies(
  ...
  if (winnerTrophies <= 0) {
    throw new Error(`Trophies value for tokenId: ${winnerTokenId} is already zero or negative`);
  }
  ...
  console.log(`TokenID ${winnerTokenId} has ${winnerTrophies - price} trophies now`);
}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
            ...
            <div style={{ display: 'flex', marginBottom: '20px' }}>
                <div style={{ marginRight: '20px', textAlign: 'center' }}>
                    ...
                    <p>Price: 1 trophy</p>
                    <button onClick={() => createTokenFireWindIce(3416, 3419, userId, '/fire.png', 1)}>Create Fire Token</button>
                </div>
                <div style={{ marginRight: '20px', textAlign: 'center' }}>
                    <h3>Gust of Distraction</h3>
                    <img src="/wind.png" alt="Wind" style={{ width: '100px', height: '100px' }} />
                    <p>Price: 2 trophies</p>
                    <button onClick={() => createTokenFireWindIce(3416, 3419, userId, '/wind.png', 2)}>Create Wind Token</button>
                </div>
                <div style={{ textAlign: 'center' }}>
                    <h3>Freeze Frame</h3>
                    <img src="/ice.png" alt="Ice" style={{ width: '100px', height: '100px' }} />
                    <p>Price: 3 trophies</p>
                    <button onClick={() => createTokenFireWindIce(3416, 3419, userId, '/ice.png', 3)}>Create Ice Token</button>
                </div>
            </div>
